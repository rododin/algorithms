package org.rododin.algorithms.tests;
...
/**
 * Provides a set of useful methods for implementing typical algorithm tests.
 *
...
public abstract class AbstractTest
{
	public static void doTest(String testInputToPassToStdIn, Runnable theCaseToTest, String resultExpectedOnStdOut)
	{
		...
		Assert.assertEquals( stringsToStringByLine(resultExpectedOnStdOut.trim())
		                   , stringsToStringByLine(producedResult.trim())
		                   );
	}
